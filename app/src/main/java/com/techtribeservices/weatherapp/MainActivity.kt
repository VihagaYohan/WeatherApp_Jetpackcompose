package com.techtribeservices.weatherapp
...
import com.techtribeservices.weatherapp.model.FutureModel
import com.techtribeservices.weatherapp.model.HourlyModel
import com.techtribeservices.weatherapp.ui.theme.WeatherAppTheme
    ...
    Box(modifier = Modifier
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            LazyColumn(
                ...
                // displaying future hourly forecast using a LazyRow
                item {
                    LazyRow(
                        ...
                        items(listOfHourlyForecast){item ->
...
val dailyItems = listOf<FutureModel>(
    ...
    FutureModel("Fri","cloudy","Cloudy",24,12)

)

// display each future daily forecasting
@Composable
fun DailyItem(item: FutureModel) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .padding(
...
// placeholder for each hourly forecast item
@Composable
fun HourlyForecastItem(model: HourlyModel) {
    Column(
        modifier = Modifier
            .width(90.dp)
            .wrapContentHeight()
